...
<pre v-code><code>
&lt;ts-slider v-model="value" :range="true" /&gt;
...
<pre v-code><code>
&lt;ts-slider v-model="value" orientation="vertical" /&gt;
...
<pre v-code><code>
&lt;ts-slider v-model="value" :step="20" /&gt;
...
<pre v-code><code>
&lt;ts-slider v-model="value" :step="20" :min="50" :max="200" /&gt;
...
<template>
    <div>
        <div>
            <h5>Basic: {{value1}}</h5>
            <ts-slider v-model="value1" />

            <h5>Input: {{value2}}</h5>
            <InputText v-model.number="value2" />
            <ts-slider v-model="value2" />

            <h5>Step: {{value3}}</h5>
            <ts-slider v-model="value3" :step="20" />

            <h5>Decimal Step: {{value4}}</h5>
            <ts-slider v-model="value4" :step="0.5" />

            <h5>Range: {{value5}}</h5>
            <ts-slider v-model="value5" :range="true" />

            <h5>Vertical: {{value6}}</h5>
            <ts-slider v-model="value6" orientation="vertical" />
        </div>
        <TsSliderDoc />
    </div>
</template>
...
<script>
import { ref } from 'vue'
import TsSliderDoc from './tsSliderDoc.vue'
