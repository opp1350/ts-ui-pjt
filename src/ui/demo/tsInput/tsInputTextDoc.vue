...
<pre v-code><code>
&lt;ts-input-text type="text" v-model="value" /&gt;
...
&lt;span class="p-float-label"&gt;
	&lt;ts-input-text id="username" type="text" v-model="value" /&gt;
...
&lt;span class="p-input-icon-left"&gt;
    ...
    &lt;ts-input-text type="text" v-model="value1" placeholder="Search" /&gt;
&lt;/span&gt;

&lt;span class="p-input-icon-right"&gt;
    &lt;ts-input-text type="text" v-model="value2" /&gt;
    &lt;i class="pi pi-spin pi-spinner" /&gt;
&lt;/span&gt;

&lt;span class="p-input-icon-left p-input-icon-right"&gt;
    &lt;i class="pi pi-search" /&gt;
    &lt;ts-input-text type="text" v-model="value3" /&gt;
    &lt;i class="pi pi-spin pi-spinner" /&gt;
&lt;/span&gt;
...
<pre v-code><code>
&lt;ts-input-text type="text" class="p-inputtext-sm" placeholder="Small" /&gt;
&lt;ts-input-text type="text" placeholder="Normal" /&gt;
&lt;ts-input-text type="text" class="p-inputtext-lg"  placeholder="Large" /&gt;
...
<template>
    <div>
        ...
        <span class="p-float-label">
            <ts-input-text id="username" type="text" v-model="value2" />
            <label for="username">Username</label>
        </span>
        ...
        <span class="p-input-icon-left">
            <i class="pi pi-search" />
            <ts-input-text type="text" v-model="value3" placeholder="Search" />
        </span>
