...
<pre v-code><code>
&lt;ts-scroll-panel style="width: 100%; height: 200px"&gt;
    content
&lt;/ts-scroll-panel&gt;
...
<pre v-code><code>
&lt;ts-scroll-panel style="width: 100%; height: 200px" class="custom"&gt;
    content
&lt;/ts-scroll-panel&gt;
        ...
        <div class="content-section implementation">
            <div class="card">
                <div class="p-grid">
                    ...
                    <div class="p-col-12 p-md-4 p-p-5">
                        <ts-scroll-panel style="width: 100%; height: 200px" class="custombar1">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                Vitae et leo duis ut diam.
                                Ultricies mi quis hendrerit dolor magna eget est lorem. Amet consectetur adipiscing elit ut.
                    ...
                    <div class="p-col-12 p-md-4 p-p-5">
                        <ts-scroll-panel style="width: 100%; height: 200px" class="custombar2">
                            <p style="width: 600px">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                Vitae et leo duis ut diam.
                                Ultricies mi quis hendrerit dolor magna eget est lorem. Amet consectetur adipiscing elit ut.
...
<script>
import TsScrollPanelDoc from './tsScrollPanelDoc';
