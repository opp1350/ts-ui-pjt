...
<pre v-code><code>
&lt;ts-dropdown v-model="selectedCity" :options="cities" optionLabel="name" placeholder="Select a City" /&gt;
...
&lt;ts-dropdown v-model="selectedGroupedCity" :options="groupedCities"
...
<pre v-code><code>
&lt;ts-dropdown v-model="selectedCar" :options="cars" optionLabel="brand" placeholder="Select a Car" :filter="true" filterPlaceholder="Find Car"/&gt;
...
<pre v-code><code><template v-pre>
&lt;ts-dropdown v-model="selectedCar" :options="cars" optionLabel="brand" :filter="true" placeholder="Select a Car" :showClear="true"&gt;
