...
export default {
    data() {
        ...
        <p>ts-colorpicker is displayed as an overlay with a preview option by default where second alternative is the inline mode.</p>
<pre v-code><code>
&lt;ts-colorpicker v-model="color" :inline="true" /&gt;
