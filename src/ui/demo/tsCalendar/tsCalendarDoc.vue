...
<pre v-code><code>
&lt;ts-calendar v-model="value" :inline="true" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" selectionMode="single || multiple || range" /&gt;

</code></pre>

        <h5>DateFormat</h5>
        <p>Default date format is yy/mm/dd, to customize this use <i>dateFormat</i> property or define it at <router-link to="/locale">PrimeVue Locale</router-link> globally. Note that standalone property overrides the value in locale settings.</p>

<pre v-code><code>
&lt;ts-calendar v-model="value" dateFormat="dd.mm.yy" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" :showTime="true" /&gt;
&lt;ts-calendar v-model="value" :showTime="true" hourFormat="12" /&gt;
&lt;ts-calendar v-model="value" :showTime="true" :timeOnly="true" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" :minDate="minDateValue" maxDate="maxDateValue" /&gt;

</code></pre>

        <p>To disable specific dates or days, restrict selectable dates use <i>disabledDates</i> and/or <i>disabledDays</i> options.</p>
<pre v-code><code>
&lt;ts-calendar v-model="value" :disabledDates="invalidDates" :disabledDays="[0,6]" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" :showButtonBar="true" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" :numberOfMonths="3" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" view="month" dateFormat="yy/mm" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" view="year" dateFormat="yy" /&gt;
...
<pre v-code><code>
&lt;ts-calendar v-model="value" :touchUI="true" /&gt;
