...
<pre v-code><code>
&lt;ts-autocomplete v-model="selectedCountry" :suggestions="filteredCountriesBasic" @complete="searchCountry($event)" field="name" /&gt;
...
<pre v-code><code>
&lt;ts-autocomplete v-model="brand" :dropdown="true" :suggestions="filteredBrands" @complete="searchBrand($event)" placeholder="Hint: type 'v' or 'f'" /&gt;
...
<pre v-code><code>
&lt;ts-autocomplete :multiple="true" v-model="selectedCountries" :suggestions="filteredCountriesMultiple" @complete="searchCountryMultiple($event)" field="name" /&gt;

</code></pre>

		<h5>Objects</h5>
		<p>ts-autocomplete can also work with objects using the  <i>field</i> property that defines the label to display
...
<pre v-code><code>
&lt;ts-autocomplete field="label" v-model="selectedCountry" :suggestions="filteredCountriesBasic" @complete="searchCountryBasic($event)" /&gt;
...
export default {
    setup() {
        ...
        return { countries, countryService, selectedCountry1, selectedCountry2, selectedCity, filteredCities, filteredCountries, selectedCountries, groupedCities, selectedItem, filteredItems, items }
    }
}
</code></pre>

<pre v-code><code><template v-pre>
&lt;ts-autocomplete v-model="selectedCity" :suggestions="filteredCities" @complete="searchCity($event)"
    field="label" optionGroupLabel="label" optionGroupChildren="items"&gt;&lt;/ts-autocomplete&gt;
</template>
</code></pre>
...
<pre v-code><code>
&lt;ts-autocomplete forceSelection v-model="brand" :suggestions="filteredBrands" @complete="searchBrand($event)" /&gt;
...
<pre v-code><code><template v-pre>
&lt;ts-autocomplete v-model="brand" :suggestions="filteredBrands" @complete="searchBrand($event)" placeholder="Hint: type 'v' or 'f'" :dropdown="true"&gt;
