...
&lt;ts-button @click="delete()" icon="pi pi-check" label="Confirm"&gt;&lt;/ts-button&gt;
</code></pre>
...
<pre v-code><code>
&lt;ts-confirm-dialog :breakpoints="{'960px': '75vw', '640px': '100vw'}" :style="{width: '50vw'}"&gt;&lt;/ts-confirm-dialog&gt;
