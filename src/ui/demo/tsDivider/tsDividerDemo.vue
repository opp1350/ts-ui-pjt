    ...
    <div>
        <div class="content-section implementation">
            ...
            <!-- <div class="card">
                ...
                <ts-divide align="left" type="dashed">
                    <b>Left</b>
                </ts-divide>
                ...
                <ts-divide align="center" type="dashed">
                    <b>Center</b>
                </ts-divide>
                ...
                <ts-divide align="right" type="dashed">
                    <b>Right</b>
                </ts-divide>
            ...
            <!-- <div class="card">
                ...
                <ts-divide align="right">
                    <ts-button label="Button" icon="pi pi-search" class="p-button-outlined"></ts-button>
                </ts-divide>
            ...
            <!-- <div class="card">
                ...
                <div class="p-grid">
                    <div class="p-col-5 p-d-flex p-ai-center p-jc-center">
                        <div class="p-fluid">
                            <div class="p-field">
                                ...
                                <ts-input-text id="username" type="text" />
                            </div>
                            <div class="p-field">
                                <label for="password">Password</label>
                                <ts-input-text id="password" type="password" />
                            </div>
                            <ts-button label="Login"></ts-button>
                        </div>
                    </div>
                    <div class="p-col-2">
                        <ts-divide layout="vertical">
                    ...
                    <div class="p-col-5 p-d-flex p-ai-center p-jc-center">
                        <ts-button label="Sign Up" icon="pi pi-user-plus" class="p-button-success"></ts-button>
                    </div>
                </div>
            </div> -->
        </div>
