<template>
    <div>
		...
		<p>ts-fieldset is a container component that accepts content as its children.</p>
<pre v-code><code>
&lt;ts-fieldset legend="Godfather I"&gt;
...
<pre v-code><code>
&lt;ts-fieldset legend="Godfather I" :toggleable="true"&gt;
	The story begins as Don Vito Corleone, the head of a New York Mafia family, oversees his daughter's wedding.
	His beloved son Michael has just come home from the war, but does not intend to become part of his father's business.
	Through Michael's life the nature of the family business becomes clear. The business of the family is just like the head of the family,
	kind and benevolent to those who give respect, but given to ruthless violence whenever anything stands against the good of the family.
...
<pre v-code><code>
&lt;ts-fieldset legend="Header Text" :toggleable="true" :collapsed="true"&gt;
	Content
&lt;/ts-fieldset&gt;
...
&lt;ts-fieldset legend="Header Text" :toggleable="true" v-model:collapsed="isCollapsed"&gt;
	Content
&lt;/ts-fieldset&gt;
...
<template>
    <div>
        ...
        <h5>Toggleable</h5>
        <ts-fieldset legend="Header" :toggleable="true">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
