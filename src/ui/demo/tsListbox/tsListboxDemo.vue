<template>
    <div>
        ...
        <div class="content-section implementation">
            <div class="card">
                <h5>Single</h5>
                <ts-listbox v-model="selectedCity" :options="cities" optionLabel="name" style="width:15rem" />

                <h5>Grouped</h5>
                <ts-listbox v-model="selectedGroupedCity" :options="groupedCities" optionLabel="label" style="width:15rem" optionGroupLabel="label" optionGroupChildren="items" listStyle="max-height:250px">
                ...
                <ts-listbox v-model="selectedCountries" :options="countries" :multiple="true" :filter="true" optionLabel="name" listStyle="max-height:250px" style="width:15rem" filterPlaceholder="Search">
...
<script>
import TsListboxDoc from './tsListboxDoc';
